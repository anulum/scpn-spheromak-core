...
# SCPN Spheromak Core — device CAD model benchmark
...
synthetic five-body device assembly: building the B-rep bodies with the
...
from scpn_spheromak_core.geometry import DeviceGeometry  # noqa: E402
from scpn_spheromak_core.parameters import (  # noqa: E402
    FluxConserverGeometry,
    FormationSource,
)

SCHEMA: Final = "scpn-spheromak-core.device-model-cad-benchmark.v1"
...
def operations() -> list[tuple[str, Callable[[], float]]]:
    ...
    from scpn_spheromak_core.geometry import build_device_cad
