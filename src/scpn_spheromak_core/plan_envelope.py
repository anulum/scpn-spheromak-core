...
# SCPN Spheromak Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-SPHEROMAK-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_spheromak_core.observability.CATALOGUE_BINDING`.
    plan_identifier
