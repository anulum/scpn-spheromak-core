...
# SCPN Spheromak Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "91ef7ec0aee62de4726b0f0260e91fad227f51f7df475e24fed5d55b413499f7"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-SPHEROMAK-CORE"
    assert NON_CLAIMS == (
