...
# SCPN Spheromak Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "rust/pyproject.toml",
    "rust/src/lib.rs",
    "rust/src/eigenvalue.rs",
    "rust/src/field.rs",
    "rust/src/formation.rs",
    "src/scpn_spheromak_core/physics/__init__.py",
    "src/scpn_spheromak_core/physics/numerics.py",
    "src/scpn_spheromak_core/physics/eigenvalue.py",
    "src/scpn_spheromak_core/physics/field.py",
    "src/scpn_spheromak_core/physics/formation.py",
    "src/scpn_spheromak_core/physics/level0.py",
    "reactor-domain.json",
    "requirements-dev.txt",
    "src/scpn_spheromak_core/__init__.py",
    "src/scpn_spheromak_core/configuration.py",
    "src/scpn_spheromak_core/errors.py",
    "src/scpn_spheromak_core/observability.py",
    "src/scpn_spheromak_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_spheromak_core/parameters.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-SPHEROMAK-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_spheromak_core import OWNED_CONFIGURATIONS, RegistryBinding
...
def test_typed_package_marker_exists() -> None:
    ...
    assert (REPO / "src" / "scpn_spheromak_core" / "py.typed").is_file()
