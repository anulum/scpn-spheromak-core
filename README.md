...
serialisation, and a data-only SPO registry pin (`src/scpn_spheromak_core/`,
...
artefact, and no parameter set describes or validates any real machine. Formation-source choices and fuel-cycle choices are
